defmodule TFLiteElixir.FlatBufferModel.Test do
  ...
  test "list_associated_files/1 on model with metadata" do
  ...
  test "get_associated_file/2 on model with metadata" do
    ...
    Anas superciliosa \\xd7 platyrhynchos (Pacific Black Duck \\xd7 Mallard hybrid)
    ...
    Nestor meridionalis septentrionalis (North Island Kaka)
    Pipilo chlorurus (Green-tailed Towhee)
    Pipilo maculatus (Spotted Towhee)
    Pipilo erythrophthalmus (Eastern Towhee)
    Cairina moschata domestica (Domestic Muscovy Duck)
    ...
    Circus cyaneus hudsonius (Northern Harrier (American))
    ...
    Phalacrocorax carbo novaehollandiae (Australasian Great Cormorant)
    Petroica macrocephala macrocephala (South Island Tomtit)
    Petroica australis longipes (North Island Robin)
    Prosthemadera novaeseelandiae novaeseelandiae (Mainland Tui)
    Asio flammeus (Short-eared Owl)
    Rhipidura fuliginosa fuliginosa (South Island Fantail)
    Scolopax minor (American Woodcock)
    Arenaria interpres (Ruddy Turnstone)
    Arenaria melanocephala (Black Turnstone)
    Rhipidura fuliginosa placabilis (North Island Fantail)
    ...
    Anser cygnoides domesticus (Domestic Swan Goose)
    ...
    Larus glaucescens \\xd7 occidentalis (Olympic Gull)
    ...
    Colaptes auratus auratus (Yellow-shafted Flicker)
    ...
    Zosterops lateralis lateralis (Silvereye (ssp. lateralis))
    Haliaeetus leucogaster (White-bellied Sea-Eagle)
    Uria aalge (Common Murre)
    Tringa semipalmata inornatus (Western Willet)
    ...
    Buteo lineatus elegans (California Red-shouldered Hawk)
    ...
    Phalacrocorax varius varius (New Zealand Pied Shag)
