defmodule TFLiteElixir.Nif do
  ...
  def interpreter_set_variables(_self, _variables), do: :erlang.nif_error(:not_loaded)
  ...
  def interpreter_variables(_self), do: :erlang.nif_error(:not_loaded)
  ...
  def interpreter_signature_keys(_self), do: :erlang.nif_error(:not_loaded)
